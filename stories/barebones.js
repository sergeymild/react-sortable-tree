...
export default class App extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      treeData: [
        { title: 'forked_development' },
        { title: 'global_store' },
        { title: 'Origin', expanded: true, children: [{title: "2.5.5-beta2", subtitle: '7 days ago'}] },
        { title: 'Chicken', expanded: true, children: [{ title: 'Egg', children: [{ title: 'Eff2' }] }] },
      ],
    };
  }
